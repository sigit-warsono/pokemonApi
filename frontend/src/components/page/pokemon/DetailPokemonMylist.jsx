      ...
      {loading ? (
        ...
        <div className="detail h-auto flex mt-[10rem] justify-center">
          ...
          <div className="card w-[70%] bg-slate-200 rounded-[15rem] p-9 flex flex-col gap-4 justify-center items-center">
            <div className="rounded-[50%] -mt-[15rem] bg-black w-[16rem] h-[15rem]">
            <img
            ...
            <div className="information">
              <span className="text-[2rem] text-[#514F4E]">{pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1)}</span>
            </div>
